...
public class Sample2 {
    ...
    @ColumnInfo(name = "c6", sqlType = DataType.JSON, converter = "raws")
    private Map<String, String> c6;

    @ColumnInfo(name = "c7", sqlType = DataType.JSON)
    private String c7;
     ...
     * @return JSON.
     */
    public Map<String, String> getC6() {
        return this.c6;
    }
     ...
     * @param c6 JSON.
     */
    public void setC6(Map<String, String> c6) {
        this.c6 = c6;
    }
